              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:cuffleycabs@gmail.com" className="hover:text-[#D4AF37] transition-colors">
                    cuffleycabs@gmail.com
                    </a>
                  </div>
                </div>
              ...
              {submitSuccess ? (
                ...
                >
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center w-full bg-black text-white py-3 px-4 rounded-md transition-colors duration-300 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : 'hover:bg-[#D4AF37] hover:text-black'
                      }`}
                  >
                    {isSubmitting ? (
